...
symbol* allocate_space_for_table_entry(char* name, int size, int type, int lineno, int scope);	//allocates space for items in the list and initialisation

//insert_into_table(arguments);
void insert_into_table(symbol* sym);	//arguments can vary based on implementation
